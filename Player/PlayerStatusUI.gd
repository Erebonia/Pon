...
func _process(_delta):
	_update_stats_ui(player.player_data.HP, player.player_data.max_HP, player.player_data.Strength, player.player_data.Magic, player.player_data.Agility, player.player_data.Defense)
	_update_level_ui(player.player_data.Level)
	_update_xp_ui(player.player_data.current_xp, player.player_data.get_required_experience(player.player_data.Level))
